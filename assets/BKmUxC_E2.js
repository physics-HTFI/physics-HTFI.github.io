import{t as e}from"./BILT4AnT.js";var t=`bonesDeclaration`,n=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`bakedVertexAnimationDeclaration`,i=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`clipPlaneVertexDeclaration`,o=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`instancesVertex`,c=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`bonesVertex`,u=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`bakedVertexAnimation`,f=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`clipPlaneVertex`,m=`#ifdef CLIPPLANE
