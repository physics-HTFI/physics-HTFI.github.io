import{t as e}from"./BILT4AnT.js";var t=`layerVertexShader`,n=`attribute vec2 position;uniform vec2 scale;uniform vec2 offset;uniform mat4 textureMatrix;varying vec2 vUV;const vec2 madd=vec2(0.5,0.5);
